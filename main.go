...
func loadTypeTokenTestCheck() {
	// Token Load Test 1
	envVar1 := "STOREGH_ORGANIZATION_ACTIONS_TEST_TOKEN_LOAD_KEY_1_BAD_SYMBOLS________"
	...
	// Token Load Test 2
	envVar2 := "STOREGH_ORGANIZATION_ACTIONS_TEST_TOKEN_LOAD_KEY_2"
	...
	// Token Load Test 3
	envVar3 := "STOREGH_ORGANIZATION_ACTIONS_TEST_TOKEN_LOAD_KEY_3"
	...
	// Token Load Test 4
	envVar4 := "STOREGH_ORGANIZATION_ACTIONS_TEST_TOKEN_LOAD_KEY_4"
	...
	// Token Load Test 5
	envVar5 := "STOREGH_ORGANIZATION_ACTIONS_TEST_TOKEN_LOAD_KEY_5"
...
func loadTypeAppTestCheck() {
	// App Load Tets 1
	envVar5 := "STOREGH_ORGANIZATION_ACTIONS_TEST_APP_LOAD_KEY_1"
	secret, found := os.LookupEnv(envVar5)
	if !found || secret == "" {
		log.Fatalf("failed to find %q value\n", envVar5)
	}
...
func updateTypeTokenTestCheck() {
	// Token Update Test 1
	envVar1 := "STOREGH_ORGANIZATION_ACTIONS_TEST_TOKEN_UPDATE_KEY_1"
	secret, found := os.LookupEnv(envVar1)
	if !found || secret == "" {
		log.Fatalf("Failed to find %q value\n", envVar1)
	}
	...
	// Token Update Test 2
	envVar2 := "STOREGH_ORGANIZATION_ACTIONS_TEST_TOKEN_UPDATE_KEY_2"
	secret, found = os.LookupEnv(envVar2)
	if !found || secret == "" {
		log.Fatalf("Failed to find %q value\n", envVar2)
	}
...
func updateTypeAppTestCheck() {
	// App Update Test 1
	envVar3 := "STOREGH_ORGANIZATION_ACTIONS_TEST_APP_UPDATE_KEY_1"
	secret, found := os.LookupEnv(envVar3)
	if !found || secret == "" {
		log.Fatalf("Failed to find %q value\n", envVar3)
	}
